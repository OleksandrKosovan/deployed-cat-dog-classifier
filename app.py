...
# docker command:
# docker run -p 8502:8501 --name=pets -v /Users/oleksandrkosovan/Documents/GitHub/deployed-cat-dog-classifier/pets/:/models/pets/1 -e MODEL_NAME=pets tensorflow/serving
